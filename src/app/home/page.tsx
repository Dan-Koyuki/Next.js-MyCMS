...
const Home = () => {
  return (
    // <ProtectedRoute>
    <div
      className="bg-[#EDF1D6] text-black h-screen flex flex-col overflow-hidden
      ...
      <div className="flex flex-row w-full">
        ...
        <div className="relative w-3/4 overflow-y-auto">
          <p>
            ...
            assumenda accusamus illo quae sapiente at, architecto aliquid ullam
            officiis laborum error!
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia
            doloribus, perspiciatis impedit iure magnam, temporibus sunt ea aut
